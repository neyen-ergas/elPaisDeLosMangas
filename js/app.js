var listaCarrito = localStorage.listaCarrito ? JSON.parse(localStorage.listaCarrito) : [];
var parrafo;
var totalPagar;
var prodAgregados;
...
async function init(){
    ...
    window.listaCatalogo = await agegarCatalogoLista();
...
function listaProductoCantidad(){
    ...
    window.listaCatalogo.forEach(prodCatalogo => {
        let cont = 0;
